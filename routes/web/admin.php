...
//    Route::get('account_settings' , [UsersController::class , 'account_settings']);
//    Route::get('profile' , [UsersController::class , 'profile']);
//});
//// Profile
//Route::prefix('profile')->group(function () {
//    Route::get('settings' , [IndexController::class , 'index'])->name('profile');
//    Route::get('settings/two-factor-auth' , [TwoFactorAuthController::class , 'twoFactorAuthManger'])->name('profile.twoFactorAuth');
//    Route::post('settings/two-factor-auth' , [TwoFactorAuthController::class , 'postTwoFactorAuthManger']);
//    Route::get('settings/mobile-Verify' , [MobileVerifyTokenController::class , 'getToken'])->name('mobile.verify');
//    Route::post('settings/mobile-Verify' , [MobileVerifyTokenController::class , 'postToken']);
//});
////restaurant
//Route::resource('cafe' , 'CafeController')->except('show');
