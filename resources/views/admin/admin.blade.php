                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar"> اندی کینگ </div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">ایرین کالینز</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">لوری فاکس</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">Luke Ivory</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">رایان کالینز </div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">نیا هیلیر</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('images/90x90.jpg')}}" alt="avatar">سونیا شاو</div></td>
                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">بلندگو</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">عینک</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">ساعت</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">لپتاپ</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">دوربین</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">کفش</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('images/90x90.jpg')}}" alt="product">هدفون</div></td>
