...
@if ($page_name != 'coming_soon' && $page_name != 'contact_us' && $page_name != 'error404' && $page_name != 'error500' && $page_name != 'error503' && $page_name != 'faq' && $page_name != 'helpdesk' && $page_name != 'maintenence' && $page_name != 'privacy' && $page_name != 'auth_boxed' && $page_name != 'auth_default')
    ...
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
...
@switch($page_name)
    ...
    @case('cafe_create')@case('cafe_edit')
    {{-- Cafe Create --}}{{-- Cafe Edit --}}
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/tables/custom-table.css')}}"/>
    ...
    <link href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css"/>
    <style>
    ...
    @case('chat')
    {{-- App chat --}}
    <link href="{{asset('./css/admin/apps/mailing-chat.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    <link href="{{asset('./css/admin/apps/contacts.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('invoice')
    {{-- App invoice --}}
    <link href="{{asset('./css/admin/apps/invoice.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('mailbox')
    {{-- App Mailbox --}}
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/editors/quill/quill.snow.css')}}">
    <link href="{{asset('./css/admin/apps/mailbox.css')}}" rel="stylesheet" type="text/css"/>
    ...
    @case('notes')
    {{-- App Notes --}}
    <link href="{{asset('./css/admin/apps/notes.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('scrumboard')
    {{-- App Scrumboard --}}
    <link href="{{asset('./css/admin/apps/scrumboard.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}" rel="stylesheet" type="text/css">
    @break
    ...
    {{-- App Todo List --}}
    <link rel="stylesheet" type="text/css" href="{{asset('plugins/editors/quill/quill.snow.css')}}">
    <link href="{{asset('./css/admin/apps/todolist.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('auth_boxed')
    {{-- Auth Lockscreen Boxed --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/authentication/form-2.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/switches.css')}}">
    @break

    @case('auth_default')
    {{-- Auth Lockscreen  --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/authentication/form-1.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/switches.css')}}">
    @break
    ...
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/tabs-accordian/custom-accordions.css')}}" rel="stylesheet"
            type="text/css"/>
    @break
    ...
    {{-- Components Block ui --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-modal.css')}}" rel="stylesheet" type="text/css">
    ...
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-carousel.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('cards')
    {{-- Components Cards --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/cards/card.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('countdown')
    {{-- Compoents Countdown --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-countdown.css')}}" rel="stylesheet" type="text/css">
    @break

    @case('counter')
    {{-- Component Counter --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-counter.css')}}" rel="stylesheet" type="text/css">
    @break
    ...
    {{-- Compoent List Group --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-list-group.css')}}" rel="stylesheet" type="text/css">
    @break
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-media_object.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    <link href="{{asset('plugins/sweetalerts/sweetalert2.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('plugins/sweetalerts/sweetalert.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/custom-sweetalert.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('tabs')
    {{-- Components Tabs --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/tabs-accordian/custom-tabs.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('timeline')
    {{-- Component Timeline --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/components/timeline/custom-timeline.css')}}" rel="stylesheet" type="text/css"/>
    <style>
        .toggle-code-snippet {
            margin-bottom: 0px;
        }
    ...
    @case('avatars')
    {{-- Elements avatar --}}
    <link href="{{asset('./css/admin/elements/avatar.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    @case('breadcrumbs')
    {{-- Elements Breadcrumb --}}
    <link href="{{asset('./css/admin/elements/miscellaneous.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/elements/breadcrumb.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    <link href="{{asset('./css/admin/elements/color_library.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    @case('infobox')
    {{-- Elements Infobox --}}
    <link href="{{asset('./css/admin/elements/infobox.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    @case('pagination')
    {{-- Elements Pagination --}}
    <link href="{{asset('./css/admin/elements/custom-pagination.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('popovers')
    {{-- Elements Popovers --}}
    <link href="{{asset('./css/admin/elements/popover.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('search')
    {{-- Elements Search --}}
    <link href="{{asset('./css/admin/elements/search.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('tooltips')
    {{-- Elements Tooltips --}}
    <link href="{{asset('./css/admin/elements/tooltip.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('treeview')
    {{-- Elements Tree View --}}
    <link href="{{asset('./css/admin/elements/custom-tree_view.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('typography')
    {{-- Elements Typography --}}
    <link href="{{asset('./css/admin/elements/custom-typography.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    {{-- Pages Coming Soon --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/coming-soon/style.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/switches.css')}}">
    @break
    ...
    @case('contact_us')
    {{-- Pages Contact Us --}}
    <link href="{{asset('./css/admin/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/contact_us.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <style>
        #content {
            width: 100%;
    ...
    {{-- Pages Error 404 --}}
    <link href="{{asset('./css/admin/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/error/style-400.css')}}" rel="stylesheet" type="text/css"/>
    <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    {{-- Pages Error 500 --}}
    <link href="{{asset('./css/admin/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/error/style-500.css')}}" rel="stylesheet" type="text/css"/>
    <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    {{-- Pages Error 503 --}}
    <link href="{{asset('./css/admin/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/error/style-503.css')}}" rel="stylesheet" type="text/css"/>
    <style>
        #content {
            width: 100%;
            margin-top: 0;
    ...
    {{-- Pages Faq --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/faq/faq.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('faq2')
    {{-- Pages Faq 2 --}}
    <link href="{{asset('./css/admin/pages/faq/faq2.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('helpdesk')
    {{-- Pages Helpdesk --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/helpdesk.css')}}" rel="stylesheet" type="text/css"/>
    @break

    @case('maintenence')
    {{-- Pages Maintenence --}}
    <link href="{{asset('./css/admin/plugins.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/error/style-maintanence.css')}}" rel="stylesheet" type="text/css"/>
    <style>
        #content {
            width: 100%;
            margin-right: 0;
    ...
    {{-- Pages Privacy --}}
    <link href="{{asset('./css/admin/main.css')}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset('./css/admin/pages/privacy/privacy.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/theme-checkbox-radio.css')}}">
    <link href="{{asset('./css/admin/tables/table-basic.css')}}" rel="stylesheet" type="text/css"/>
    @break
    ...
    {{-- Widgets --}}
    <link href="{{asset('plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/widgets/modules-widgets.css')}}">
    @break
    ...
    {{-- Forms Clipboard --}}
    <link href="{{asset('./css/admin/scrollspyNav.css')}}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" type="text/css" href="{{asset('./css/admin/forms/custom-clipboard.css')}}">
    @break
