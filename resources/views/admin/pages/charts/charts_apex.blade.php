        ...
        <div class="container">
            ...
            <div id="navSection" data-spy="affix" class="nav sidenav">
                <div class="sidenav-content">
                    <a href="#chartLine" class="active nav-link">خط</a>
                    <a href="#chartArea" class="nav-link"> منطقه </a>
                    <a href="#chartColumn" class="nav-link"> ستون </a>
                    <a href="#chartColumnStacked" class="nav-link"> ستون انباشته </a>
                    <a href="#chartBar" class="nav-link">نوار</a>
                    <a href="#chartMixed" class="nav-link"> مختلط </a>
                    <a href="#chartDonut" class="nav-link"> دونات </a>
                    <a href="#chartRadial" class="nav-link"> شعاعی </a>
                </div>
            </div>
