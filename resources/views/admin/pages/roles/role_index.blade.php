...
{{--                                @php($num = 1)--}}
                                @foreach($roles as $role)
                                    <tr>
                                        ...
                                        <td class="text-center user-name">{{$role->name}}</td>
                                        <td class="text-center">{{$role->label}}</td>
                                        <td class="text-center">{{$role->description}}</td>
                                        {{--<td class="text-center">{{$role->user->name.' '.$role->user->lastname}}</td>--}}
                                        <td class="text-center">
                                            <form action="{{route('admin.roles.destroy',$role->id)}}" method="post" class="table-controls">
                                                @csrf
                                                @method('DELETE')
                                                <li>
                                                    <a href="{{route('admin.roles.edit',$role->id)}}" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
