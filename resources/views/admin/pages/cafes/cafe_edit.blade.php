            ...
            <div class="account-content">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 layout-spacing">
                        <form action="{{route('admin.cafe.index')}}/{{ $cafe->id }}" method="post" id="general-info" class="section general-info" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header lines">
                                    <div class="row col-12 ">
                                        <h4>ویرایش رستوران {{ $cafe->name ?? ''}}</h4>
                                    </div>
                                </div>
                                <div class="info">
                                    <div class="form-row">
                                        <div class="form-group col-lg-5 col-md-5 col-sm-5 ">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" value="{{old('name') ?? $cafe->name}}" placeholder="نام رستوران">
                                            @error('name')
                                        ...
                                        <div class="form-group col-lg-4 col-md-4 col-sm-4 ">
                                            ...
                                            <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" id="code" value="{{old('code') ?? $cafe->code}}" placeholder="کد اختصاصی رستوران">
                                            @error('code')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-4 col-md-10 col-sm-10 col-7 ">
                                        ...
                                        <div class="form-group col-lg-2 col-md-2 col-sm-2 col-5">
                                            ...
                                            <select name="priceLvl" class="form-control selectpicker @error('priceLvl') is-invalid @enderror">
                                                ...
                                                <option value="$" {{ ($cafe->priceLvl === '$') ? 'selected' : '' }}>$</option>
                                                <option value="$$" {{ ($cafe->priceLvl === '$$') ? 'selected' : '' }}>$$</option>
                                                <option value="$$$" {{ ($cafe->priceLvl === '$$$') ? 'selected' : '' }}>$$$</option>
                                                <option value="$$$$"{{ ($cafe->priceLvl === '$$$$') ? 'selected' : '' }}>$$$$</option>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="owner" class="form-control selectpicker @error('owner') is-invalid @enderror" data-live-search="true" multiple="multiple">
                                                <option data-content="<img src='{{asset('storage/img/profile-1.jpeg')}}' height='30px' style='border-radius: 15px;'> &nbsp; {{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 1">{{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 1</option>
                                                <option data-content="<img src='{{asset('storage/img/profile-1.jpeg')}}' height='30px' style='border-radius: 15px;'> &nbsp; {{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 2">{{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 2</option>
                                                <option data-content="<img src='{{asset('storage/img/profile-1.jpeg')}}' height='30px' style='border-radius: 15px;'> &nbsp; {{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 3">{{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 3</option>
                                                <option data-content="<img src='{{asset('storage/img/profile-1.jpeg')}}' height='30px' style='border-radius: 15px;'> &nbsp; {{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 4">{{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 4</option>
                                                <option data-content="<img src='{{asset('storage/img/profile-1.jpeg')}}' height='30px' style='border-radius: 15px;'> &nbsp; {{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 5">{{ Auth::user()->name ?? 'name' }} {{ Auth::user()->lastName ?? 'lastName' }} 5</option>
                                            </select>
                                            @error('owner')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-row">
                                        <div class="col-12 mx-0">
                                            <div class="row">
                                                <div class="col-xl-9 pr-xl-1 m-0">
                                                    <div class="form-group">
                                                        <label for="address"> نشانی پستی رستوران</label>
                                                        <textarea name="address" id="address" class="form-control textarea @error('address') is-invalid @enderror" maxlength="225" rows="5" placeholder="آدرس ">{{old('address') ?? $cafe->address}}</textarea>
                                                        @error('address')
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="row">
                                                        <div class="form-group col-xl-12 col-sm-6 pl-xl-1 pr-sm-1 pr-xl-3 mb-2">
                                                            <label for="zipCode">کد پستی رستوران</label>
                                                            <input type="text" name="zipCode" class="form-control @error('zipCode') is-invalid @enderror" id="zipCode" value="{{old('zipCode') ?? $cafe->zipCode}}" placeholder="کد پستی">
                                                            @error('zipCode')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong></span>
                                                            @enderror
                                                        </div>
                                                        <div class="form-group col-xl-12 col-sm-6 pl-xl-1 pl-sm-1 ">
                                                            <label for="tel">تلفن رستوران</label>
                                                            <input type="text" name="tel" class="form-control @error('tel') is-invalid @enderror" id="tel" value="{{old('tel') ?? $cafe->tel}}" placeholder="تلفن رستوران">
                                                            @error('tel')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong></span>
                                                            @enderror
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-lg-5 col-md-5 col-sm-5 ">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input type="text" name="instagram" class="form-control @error('instagram') is-invalid @enderror" id="instagram" value="{{old('instagram') ?? $cafe->instagram}}" placeholder="آیدی اینستاگرام">
                                            </div>
                                            @error('instagram')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group col-lg-7 col-md-7 col-sm-7 ">
                                            ...
                                            <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" id="location" value="{{old('location') ?? $cafe->location }}" placeholder="موقعیت جغرافیای">
                                            @error('location')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                    ...
                                    {{--آپلود عکس چندگانه--}}
                                    <div id="fuMultipleFile" class="layout-spacing">
                                        <div class="statbox widget box box-shadow">
